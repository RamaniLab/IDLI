...
p3 = read.table('plotme_vplots_clusters.txt')
p2 = read.table('plotme_lengths_clusters.txt')
p1 = read.table('plotme_accplots_clusters.txt')
...
# Load the data
p3 = read.table('plotme_vplots_clusters.txt', header=FALSE)
...
categories_to_mirror <- c(5, 6, 11, 12, 14) #always change these yourself!
...
dend_plot <- fviz_dend(hclust_result, 
                       k = 7, # Cut into 7 clusters - typical for most IDLI analyses, can adjust
                       cex = 0.5, 
